...
namespace Jenetics
{
        ...
        where T : class, ISelector<DoubleGene, double>
    {
        ...
        private const double Max = 1000.0;
        ...
        {
            IList<int> sizes = new List<int> {0, 1, 2, 3, 5, 11, 50, 100, 10000};
            IList<int> counts = new List<int> {0, 1, 2, 3, 5, 11, 50, 100, 10000};
        ...
        {
            Func<Genotype<DoubleGene>> F = delegate ()
            {
