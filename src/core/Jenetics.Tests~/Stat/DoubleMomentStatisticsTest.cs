...
namespace Jenetics.Stat
{
    public class DoubleMomentStatisticsTest
    {
        ...
        public static IEnumerable<object[]> SampleCounts()
        {
            ...
            yield return new object[] {1000, 0.0001};
            yield return new object[] {10000, 0.00001};
            yield return new object[] {100000, 0.000001};
            yield return new object[] {1000000, 0.0000001};
            yield return new object[] {2000000, 0.0000005};
        }
